    ...
    return this.each(function() {
      ...
      function _getControllerHtml() {
        ...
        if (settings.sliders) {
          ...
          /* mircmm: my special cases, H S & L one by one */
          if (settings.order.hslH !== false) {
            sliders[settings.order.hslH] = '';
          ...
          if (settings.order.hslS !== false) {
            sliders[settings.order.hslS] = '';
          ...
          if (settings.order.hslL !== false) {
            sliders[settings.order.hslL] = '';
